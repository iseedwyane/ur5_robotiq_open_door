...
def main():
    # 正运动学
    # 输入： 关节1-6角度（弧度），6x1矩阵[angle1,..,angle6]， c=0
    # 输出： 旋转矩阵4x4，其中位置信息单位： cm
    #joint_ang = mat('-2.473368231450216; -1.4979217688189905; -1.0000508467303675; 5.5057525634765625; 4.811411380767822; -3.865255896245138')
    joint_ang = mat('[0.854862268; -1.069363233; 0.71122167; -2.932502209; 6.210754143; -2.331585348]')
    pos = HTrans(joint_ang, 0)
    print "正运动学如下："
    print pos
    # 逆运动学
    # 输入： 旋转矩阵4x4
